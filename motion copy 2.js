...
var adaptiveUI = {
	...
	motionHandler1: function (motionData){
		...
		if((today.getTime() - adaptiveUI.lastMotionEvent) > adaptiveUI.motionInterval){	
			...
			isShaking = adaptiveUI.wasShaken(motionData.acceleration.x, motionData.acceleration.y, motionData.acceleration.z)
			...
			console.log(adaptiveUI.wasShaken(motionData.acceleration.x, motionData.acceleration.y, motionData.acceleration.z) + " " + (today.getTime() - adaptiveUI.lastMotionEvent))
			//for debugging
